...
public class TestConcession implements ClipboardOwner {
	...
	public static int testAdd() {
		int note=100;
		System.out.println("\nTest de la methode add de Concession");
		Class cl = getClass("concession.Concession");
	...
	public static void main(String[] args) {
		...
		try {
			nTestsAdd = testAdd();
			System.out.println("--> "+nTestsAdd+"/100");
		} catch(Throwable e) {
			afficheThrowable(e, "testAdd");
		}
		finally {
	...
	public static void setClipboardContentsStatic(String s) {
		TestConcession t = new TestConcession();
